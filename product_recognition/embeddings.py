"""Embedding model loading and image embedding extraction utilities.

This module owns all image-to-vector conversion for memory-bank creation,
threshold optimization, and inference. Keeping embedding logic in one place is
important because the same preprocessing, model, dtype, and normalization must
be used everywhere.
